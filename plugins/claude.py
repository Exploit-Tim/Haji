...
__MODULES__ = "Claude"
__HELP__ = """
<blockquote>⪼ **--Command help Claude--**</blockquote>

<blockquote>**Chat dengan claude** </blockquote>
**ᐉ Keterangan: Anda bisa chat dengan claude ai**
ᐈ Perintah: `{0}claude` (prompt)
    
<blockquote>**Stop Obrolan**</blockquote>
**ᐉ Keterangan: Stop chat obrolan**
ᐈ Perintah: `{0}stop claude`
