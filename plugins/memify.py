...
from Haji.helpers import CMD, Emoji, Sticker

__MODULES__ = "Memify"
__HELP__ = """
<blockquote>⪼ **--Command help Memify--**</blockquote> 

<blockquote>**Add text to sticker**</blockquote>
**ᐉ Keterangan: Tambahkan teks di atas stiker**
ᐈ Perintah: `{0}mmf text` (reply sticker)
**ᐉ Keterangan: Tambahkan teks di bagian bawah stiker**
ᐈ Perintah: `{0}mmf ;text` (reply sticker)
