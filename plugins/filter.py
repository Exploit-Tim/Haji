...
__MODULES__ = "Filters"
__HELP__ = """
<blockquote>⪼ **--Command help Filters--**</blockquote>

<blockquote>**Save filter**</blockquote>
**ᐉ Keterangan: Anda dapat mengaktifkan pesan balasan otomatis dari perintah ini**
ᐈ Perintah: `{0}filter` (name) (reply message)

<blockquote>**Get list filters** </blockquote>
**ᐉ Keterangan: Lihat semua pesan filter yang tersimpan dari akun Anda** 
ᐈ Perintah: `{0}filters`

<blockquote>**Get raw filter**</blockquote>
**ᐉ Keterangan: Anda bisa mendapatkan format filter dari perintah ini**
ᐈ Perintah: `{0}getfilter` (name) raw

<blockquote>**Stop filter** </blockquote>
**ᐉ Keterangan: Anda dapat menghentikan pesan filter pada obrolan jika Anda mau**
ᐈ Perintah: `{0}stop` (name)

<blockquote>**Stop all filter**</blockquote>
**ᐉ Keterangan: Perintah ini mudah untuk menghapus semua pesan filter yang tersimpan**
ᐈ Perintah: `{0}stop all`
