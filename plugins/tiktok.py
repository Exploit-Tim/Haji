...
__HELP__ = """
<blockquote>⪼ **--Command help TikTok Download--**</blockquote>

<blockquote>**Download media from tiktok**</blockquote>
**ᐉ Keterangan: Anda dapat mengunduh media dari tiktok tanpa tanda air, atau mengunduh media dari url**
ᐈ Perintah: `{0}ttdl` (url)
