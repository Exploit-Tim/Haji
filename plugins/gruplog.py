...
__MODULES__ = "Logs"
__HELP__ = """
<blockquote>⪼ **--Command help Logs--**</blockquote>

<blockquote>**On off gruplogs**</blockquote>
**ᐉ Keterangan: Atur gruplog Anda, jika Anda mengaktifkannya, Anda akan membuat gruplog dan menerima pesan dari bot
untuk pesan pribadi yang masuk atau tag di grup obrolan**
ᐈ Perintah: `{0}logs` (on/off)
