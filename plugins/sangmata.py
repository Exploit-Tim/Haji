__MODULES__ = "History"
__HELP__ = """
<blockquote>⪼ **--Command help History--**</blockquote>

<blockquote>**Get history name**</blockquote>
**ᐉ Keterangan: Dapatkan nama riwayat dari pengguna yang Anda inginkan**
ᐈ Perintah: `{0}sg` (userid/username)
