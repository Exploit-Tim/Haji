__MODULES__ = "Mail"
__HELP__ = """
<blockquote>⪼ **--Command help Mail--**</blockquote>

<blockquote>**Generate mail**</blockquote>
**ᐉ Keterangan: Anda dapat membuat email palsu dari perintah ini**
ᐈ Perintah: `{0}mail gen`

<blockquote>**Get otp from mail**</blockquote>
**ᐉ Keterangan: Setelah Anda membuat email palsu, dapatkan otp dari perintah ini**
ᐈ Perintah: `{0}mail otp` (id)

<blockquote>**View list mail**</blockquote>
**ᐉ Keterangan: Anda dapat melihat daftar email setelah Anda membuat**
ᐈ Perintah: `{0}mail list`
