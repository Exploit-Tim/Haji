__MODULES__ = "Saweria"
__HELP__ = """
<blockquote>⪼ **--Command help Saweria--**</blockquote>

<blockquote>**Saweria login**</blockquote>
**ᐉ Keterangan: Anda dapat masuk ke saweria dengan perintah ini**
ᐈ Perintah: `{0}saweria login` (balas pesan dengan format email dan kata sandi)

<blockquote>**Saweria check payment**</blockquote>
**ᐉ Keterangan: Jika anda mempunyai id payment saweria, anda bisa mengeceknya dengan perintah ini**
ᐈ Perintah: `{0}saweria cekpay` (id payment)

<blockquote>**Saweria check balance**</blockquote>
**ᐉ Keterangan: Anda dapat memeriksa saldo dari akun saweria Anda**
ᐈ Perintah: `{0}saweria balance`

<blockquote>**Saweria create payment**</blockquote>
**ᐉ Keterangan: Anda dapat membuat pembayaran baru dengan jumlah**
ᐈ Perintah: `{0}saweria payment` (jumlah) 
 
<blockquote>**Note**: jika anda ingin menggunakan fitur ini, silahkan login terlebih dahulu.</blockquote>
