...
from Haji.helpers import CMD, Emoji, Message, Quotly

__MODULES__ = "Carbon"
__HELP__ = """
<blockquote>⪼ **--Command help Carbonara--**</blockquote>

<blockquote>**Buat carbonara**</blockquote>
**ᐉ Keterangan: Anda bisa generate carbonara dari teks**
ᐈ Perintah: `{0}carbon` (reply text)
...
async def _(client, message):
    ...
    if not message.reply_to_message:
        await message.reply(f"{em.gagal}**Harap reply ke teks atau dokumen!**")
        return
