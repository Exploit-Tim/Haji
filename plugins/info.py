...
__MODULES__ = "Info"
__HELP__ = """
<blockquote>⪼ **--Command help Info--**</blockquote>

<blockquote>**Get information user**</blockquote>
**ᐉ Keterangan: Anda bisa mendapatkan informasi tentang pengguna**
ᐈ Perintah: `{0}info` (username/reply user)
        
<blockquote>**Get information chat**</blockquote>
**ᐉ Keterangan: Anda bisa mendapatkan informasi tentang obrolan**
ᐈ Perintah: `{0}cinfo` (chatid)
