__MODULES__ = "Cuaca"
__HELP__ = """
<blockquote>⪼ **--Command help Cuaca--**</blockquote>

<blockquote>**Dapatkan status cuaca negara**</blockquote>
**ᐉ Keterangan: Dapatkan status informasi cuaca dari suatu negara**
ᐈ Perintah: `{0}cuaca` (country)
