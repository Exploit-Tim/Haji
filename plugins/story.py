__MODULES__ = "Story"
__HELP__ = """
<blockquote>⪼ **--Command help Story--**</blockquote>

<blockquote>**Post story**</blockquote>
**ᐉ Keterangan: Anda dapat memposting media ke cerita telegram** 
ᐈ Perintah: `{0}story post` (reply media)
    
<blockquote>**Check story**</blockquote>
**ᐉ Keterangan: Dapatkan semua cerita di akun Anda**
ᐈ Perintah: `{0}story cek`

<blockquote>**Delete story**</blockquote>
**ᐉ Keterangan: Anda dapat menghapus cerita dengan perintah ini**
ᐈ Perintah: `{0}story del` (strory id)

<blockquote>**Get or steal story**</blockquote>
**Anda dapat mencuri cerita dari pengguna**
ᐈ Perintah: `{0}story get` (url)
