...
__MODULES__ = "Qrcode"
__HELP__ = """
<blockquote>⪼ **--Command help QRcode--**</blockquote>

<blockquote>**Generate barcode**</blockquote>
**ᐉ Keterangan: Hasilkan kode qr dari teks**
ᐈ Perintah: `{0}qr gen` (code)

<blockquote>**Read barcode**</blockquote>
**ᐉ Keterangan: Dapatkan kode teks dari gambar qr**
ᐈ Perintah: `{0}qr read` (reply image)
