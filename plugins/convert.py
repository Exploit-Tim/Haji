...
__MODULES__ = "Convert"
__HELP__ = """
<blockquote>⪼ **--Command help Convert--**</blockquote>

<blockquote>**Convert stiker ke gambar**</blockquote>
**ᐉ Keterangan: Convert pesan stiker menjadi gambar**
ᐈ Perintah: `{0}toimg` (reply sticker)

<blockquote>**Convert image ke stiker**</blockquote>
**ᐉ Keterangan: Convert gambar menjadi sticker**
ᐈ Perintah: `{0}tosticker` (reply image)

<blockquote>**Convert video ke gif**</blockquote>
**ᐉ Keterangan: Convert video menjadi gif**
ᐈ Perintah: `{0}togif` (reply video)

<blockquote>**Convert video ke audio**</blockquote>
**ᐉ Keterangan: Convert menjadi audio dari video yang di reply**
ᐈ Perintah: `{0}toaudio` (reply video)
