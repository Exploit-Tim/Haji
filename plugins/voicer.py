...
__MODULES__ = "Voice"
__HELP__ = """
<blockquote>⪼ **--Command help Voice--**</blockquote>

<blockquote>**Send text to voice**</blockquote>
**ᐉ Keterangan: Anda dapat mengubah teks menjadi suara**
ᐈ Perintah: `{0}tts` (text/reply text)

<blockquote>**Get text from voice**</blockquote>
**ᐉ Keterangan: Anda dapat mengonversi teks dari suara**
ᐈ Perintah: `{0}stt` (reply audio)

<blockquote>**Extract instruments**</blockquote>
**ᐉ Keterangan: Anda dapat mengekstrak instrumen dari media**
ᐈ Perintah: `{0}vremover` (reply audio)
