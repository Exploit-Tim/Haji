...
__MODULES__ = "Sticker"
__HELP__ = """
<blockquote>⪼ **--Command help Sticker--**</blockquote>

<blockquote>**Add remove pack**</blockquote>
**ᐉ Keterangan: Tambahkan stiker ke paket Anda**
ᐈ Perintah: `{0}kang` (reply sticker)
**Hapus stiker dari paket Anda**
ᐈ Perintah: `{0}unkang` (reply sticker)
        
<blockquote>**Get information stickers**</blockquote>
**Dapatkan informasi dari stiker dengan perintah ini**
ᐈ Perintah: `{0}gstik` (reply sticker)
