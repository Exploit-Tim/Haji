...
__MODULES__ = "Bingai"
__HELP__ = """
<blockquote>⪼ **--Command help BingAi--**</blockquote>

<blockquote>**Generate gambar dengan bingai**</blockquote>
**ᐉ Keterangan: Anda bisa generate image ai dengan Bingai dari prompt command**
ᐈ Perintah: `{0}bingai` (prompt)
