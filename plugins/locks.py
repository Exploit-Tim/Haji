...
__MODULES__ = "Locks"
__HELP__ = """
<blockquote>⪼ **--Command help Locks--**</blockquote>

<blockquote>**Basic command**</blockquote>
**ᐉ Keterangan: Untuk melihat jenis kunci**
ᐈ Perintah: `{0}locktypes`
**ᐉ Keterangan: Lihat izin dari obrolan**
ᐈ Perintah: `{0}locks`
    
<blockquote>**Lock unlock**</blockquote>
**ᐉ Keterangan: Anda dapat mengunci beberapa izin dari obrolan**
ᐈ Perintah: `{0}lock` (type)
**ᐉ Keterangan: Anda dapat membuka beberapa izin dari obrolan**
ᐈ Perintah: `{0}unlock` (type)
