...
__MODULES__ = "Qur'an"
__HELP__ = """
<blockquote>⪼ **--Command help Qur'an--**</blockquote>

<blockquote>**Get detail about surah** </blockquote>
**ᐉ Keterangan: Dapatkan informasi dari surah, seperti audio, qori, tempat dan cerita surah**
ᐈ Perintah: `{0}surat` (name)
        
<blockquote>**View list all surah**</blockquote>
**ᐉ Keterangan: Lihat semua nama surah**
ᐈ Perintah: `{0}listsurah`
<b>   {1}</b>"""
