__MODULES__ = "Copy"
__HELP__ = """
<blockquote>⪼ **--Command help Copy--**</blockquote>

<blockquote>**Dapatkan pesan dan media dari grup atau channel**</blockquote>
**ᐉ Keterangan: Anda bisa mencuri pesan atau media dari grup atau channel**
ᐈ Perintah: `{0}copy` (url)
        
<blockquote>**Dapatkan pesan dengan hitungan**</blockquote>
**ᐉ Keterangan: Perintah ini dapat mencuri atau mendapatkan media pesan hanya dengan jumlah pesan**
ᐈ Perintah: `{0}copyall` (url) (count)

<blockquote>**Note**: Untuk command `copyall` hanya support media.</blockquote>
...
async def _(client, message):
    ...
    if len(args) < 2:
        return await message.reply(
            f"**Please give link**\nExample: `{message.text.split()[0]} https://t.me/gcsupportmek/5039 5`"
        )
    ...
    if reply:
        ...
        if len(message.command) < 2:
            return await proses.edit(
                f"{em.gagal}<b>Please give link!!</\n\nExample: `{message.text.split()[0]} https://t.me/gcsupportmek/5039 </b>"
            )
