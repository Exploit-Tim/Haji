...
__MODULES__ = "Fake"
__HELP__ = """
<blockquote>⪼ **--Command help Fake--**</blockquote>

<blockquote>**Fake send typing** </blockquote>
**ᐉ Keterangan: Anda dapat mengirim typing palsu ke obrolan, durasi default adalah 3600 detik**
ᐈ Perintah: `{0}ftype` (seconds)

<blockquote>**Fake send video** </blockquote>
**ᐉ Keterangan: Anda dapat mengirim video palsu ke obrolan, durasi default adalah 3600 detik**
ᐈ Perintah: `{0}fvideo` (seconds)

<blockquote>**Fake send sticker** </blockquote>
**ᐉ Keterangan: Anda dapat mengirim stiker palsu ke obrolan, durasi default adalah 3600 detik**
ᐈ Perintah: `{0}fstik` (seconds)

<blockquote>**Fake send voice**</blockquote> 
**ᐉ Keterangan: Anda dapat mengirim suara palsu ke obrolan, durasi default adalah 3600 detik**
ᐈ Perintah: `{0}fvoice` (seconds)

<blockquote>**Stop fake** </blockquote>
**ᐉ Keterangan: Perintah ini untuk menghentikan fake action**
ᐈ Perintah: `{0}fcancel` (taskid)
