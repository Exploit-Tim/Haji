...
from Haji.helpers import CMD, ApiImage, Emoji

__MODULES__ = "Image"
__HELP__ = """
<blockquote>⪼ **--Command help Image--**</blockquote>

<blockquote>**Remove background**</blockquote>
**ᐉ Keterangan: Anda dapat menghapus latar belakang dari gambar**
ᐈ Perintah: `{0}rbg` (reply image)

<blockquote>**Blur image**</blockquote>
**ᐉ Keterangan: Tambahkan efek blur pada gambar**
ᐈ Perintah: `{0}blur` (reply image)

<blockquote>**Mirror image**</blockquote>
**ᐉ Keterangan: Anda dapat membalik gambar secara mirror**
ᐈ Perintah: `{0}mirror` (reply image)

<blockquote>**Negative image**</blockquote>
**ᐉ Keterangan: Tambahkan efek negatif pada gambar**
ᐈ Perintah: `{0}negative` (reply image)

<blockquote>**Search image**</blockquote>
**Dapatkan gambar yang mengagumkan untuk wallpaper**
ᐈ Perintah: `{0}wall`
**Dapatkan gambar anime yang cantik**
ᐈ Perintah: `{0}waifu`
**Dapatkan gambar dengan perintah Anda**
ᐈ Perintah: `{0}pic` (prompt)
**Dapatkan gif dengan perintah Anda**
ᐈ Perintah: `{0}gif` (prompt)
