...
from Haji.helpers import CMD, Emoji, Quotly

__MODULES__ = "Quote"
__HELP__ = """
<blockquote>⪼ **--Command help Quotly--**</blockquote>

<blockquote>**Make quote text with color** </blockquote>
**ᐉ Keterangan: Anda dapat membuat kutipan pesan dengan warna acak atau warna khusus, cukup berikan nama warna setelah perintah**
ᐈ Perintah: `{0}q pink` (reply message)

<blockquote>**Make fake quote text** </blockquote>
**ᐉ Keterangan: Anda dapat membuat pengguna kutipan palsu pesan dengan pesan ini**
ᐈ Perintah: `{0}q @PakHajiUserbot` (reply message)

<blockquote>**View quote color** </blockquote>
**ᐉ Keterangan: Dapatkan warna yang didukung untuk kutipan**
ᐈ Perintah: `{0}qcolor`
