...
__HELP__ = """
<blockquote>⪼ **--Command help PMPermit--**</blockquote>

<blockquote>**On off pmpermit**</blockquote>
**ᐉ Keterangan: Set to on pmpermit**
ᐈ Perintah: `{0}pmpermit set on`
**ᐉ Keterangan: Set to off pmpermit**
ᐈ Perintah: `{0}pmpermit set off`

<blockquote>**Set media pmpermit**</blockquote>
**ᐉ Keterangan: Anda dapat mengatur media sesuai keinginan Anda, media dapat diatur berupa foto, video**
ᐈ Perintah: `{0}pmpermit media` (reply media)

<blockquote>**Set text pmpermit**</blockquote>
**ᐉ Keterangan: Anda dapat mengubah teks khusus ke pesan pmpermit Anda**
ᐈ Perintah: `{0}pmpermit teks` (text/reply text)

<blockquote>**Set warn pmpermit**</blockquote>
**ᐉ Keterangan: Anda dapat mengatur peringatan pmpermit untuk pesan masuk**
ᐈ Perintah: `{0}pmpermit warn` (number) or 10

<blockquote>**Get status pmpermit**</blockquote>
**ᐉ Keterangan: Untuk perintah ini, Anda bisa mendapatkan status, teks, peringatan, dan media dari pmpermit atau Anda bisa melihat contoh di bawah ini**
ᐈ Perintah: `{0}pmpermit get` (teks/media)

<blockquote>**Approve disapprove user**</blockquote>
**ᐉ Keterangan: Perintah ini untuk menyetujui pesan pengguna**
ᐈ Perintah: `{0}ok`
**ᐉ Keterangan: Perintah ini untuk menolak pesan pengguna**
ᐈ Perintah: `{0}no`
    
<blockquote>**Contoh:**
`{0}pmpermit set on` (mengaktifkan pmpermit)
`{0}pmpermit set off` (menonaktifkan pmpermit)
`{0}pmpermit teks mohon bersabar, jangan spam` (mengatur teks pmpermit)</blockquote>
